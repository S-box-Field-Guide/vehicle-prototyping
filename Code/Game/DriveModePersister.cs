...
/// (design intent: a drive mode you set saves between sessions, so selecting Sport means you are
/// still on Sport next time you play). ONE global preference, not per-car.
///
